...
exports.callback = function (req, res, next) {
  async.waterfall([
    ...
    function(tempToken, dropboxAccessToken, cb) {
      ...
      cluestr.getAccessToken(token.cluestrToken, serverUrl + '/init/connect', function(err, cluestrAccessToken) {
        console.log("getAT", err, cluestrAccessToken);
        cb(null, tempToken, cluestrAccessToken, dropboxAccessToken)
      });
    },
