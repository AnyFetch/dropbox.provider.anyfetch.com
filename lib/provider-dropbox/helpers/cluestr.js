...
var API_ROOT = 'http://localhost:2201';
...
module.exports = function(appId, appSecret) {
  ...
  */
   ...
   *
   */
  this.sendDocument = function(datas, file, cb) {
    ...
    request.post(params, function(err, resp) {
      ...
      if(!file) {
        ...
        // Upload file
        var r = request.post('http://localhost:8000/providers/documents/hello/file', function(err, respFile, body) {
          if(err) {
            return cb(err);
          }
